            ...
            <div className="play-introduction">
                ...
                <div className="Remote-unique">
                    <div className="horn-div">
                        <div className="horn click" onClick={this.hornClick}></div>
                        <p className="remote-unique-text ">Horn</p>
                    </div>
                    <div className="light-div">
                        <div className="light click" onClick={this.lightClick}></div>
                        <p className="remote-unique-text ">Light</p>
                    </div>
                    <div className="spin-div">
                        <div className="spin click" onClick={this.spinClick}></div>
