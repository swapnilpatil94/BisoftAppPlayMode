...
class Piano extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ternIsConnected: false,
            clickedData: '0',

            ternIsConnectedStyle: {
        ...
        setInterval(() => {
            ...
            if (!this.state.ternIsConnected) {
                const disconnected = {
                    backgroundImage: `url('/imagesplay/illus_tern_piano.png')`,
                    position: 'relative',
                    top: '-7vw',
                    left: ' 51vw',
                    width: '21vw',
                ...
                this.setState({ ternIsConnectedStyle: disconnected })
        ...
        return (
            <div className="play-introduction">
                ...
                <div className="set">
                    ...
                    <div className="tern-device-music" style={this.state.ternIsConnectedStyle} />
